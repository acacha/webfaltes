...
Epoch.prototype.calConfig = function () //PRIVATE: initialize calendar variables
{
  ...
  this.rangeYearUpper = 2110;
  this.minDate = new Date(1910,0,1);
  this.maxDate = new Date(2110,0,1);
...
//Nom�s utilitzat per l'exemple localization_example.php
$supported_locales = array('en_US', 'sr_CS', 'de_CH','es_ES');
$encoding = 'ISO-8859-1';

//Agafar el locale del par�metre lang
...
echo ("  this.daylist = new Array('$Su','$Mo','$Tu','$We','$Th','$Fr','$Sa','$Su','$Mo','$Tu','$We','$Th','$Fr','$Sa'); /*<lang:en>*/");
echo ("  this.months_sh = new Array('$Jan','$Feb','$Mar','$Apr','$May','$Jun','$Jul','$Aug','$Sep','$Oct','$Nov','$Dec');");
echo ("  this.monthup_title = '".T_('Go to the next month')."';");
echo ("  this.monthdn_title = '".T_('Go to the previous month')."';");
echo ("  this.clearbtn_caption = '".T_('Clear')."';");
echo ("  this.clearbtn_title = '".T_('Clears any dates selected on the calendar')."';");
echo ("  this.maxrange_caption = '".T_('This is the maximum range')."';");
echo <<<EPP
};

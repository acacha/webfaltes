...
<center>
<form name="tipus_informe" method="post" action="reports/Llistat_alumnes_grup.php">
<table border="0" bgcolor="#f6f6f6">
	<tr>
		<td>
		<p>{t}Selecciona el grup:{/t}: 
		</td>
	...
	<tr>
		...
		<p>
		<input type="checkbox" id="chk" name="chk" checked="checked" onchange="checked2()">Amb photo
		<br>
